# Procedimiento de ChatGPT Web para preparar una solicitud a Codex Web - Cortex
...
6. Confirma que los archivos docs/solicitud_de_artefactos.md, csv/, docs/table_hierarchy.json y docs/filemap_ascii.txt cuentan la misma historia.
