# Procedimiento_de_solicitud_de_artefactos - Prueba2
...
## Primera iteracion - Investigacion sobre Prueba2
...
2. Propone un plan operativo para el agente que incluya lectura de AGENTS, generacion de artefactos reutilizables y validaciones necesarias antes de producir codigo.
3. Actualiza docs/table_hierarchy.json para reflejar la relacion entre artefactos reutilizables y productos finales, indicando que partes pertenecen a Core y cuales a Sandbox.
4. Documenta cualquier insumo pendiente (credenciales, datos, decisiones de negocio) y valida que la solicitud sea suficiente para que Codex trabaje de forma autonoma.
5. Indica explicitamente que este procedimiento debe eliminarse cuando la solicitud y su soporte esten completos y aprobados.
