...
* **Procedimiento_de_solicitud_de_artefactos.md** – Guía oficial para preparar solicitudes estandarizadas (estructura de carpetas, CSV y plantillas) antes de pedir trabajo a Codex. Consulta también `docs/SOP_SPECS_updated.md` si necesitas el historial previo.
