...
Este documento complementa el AGENTS general de Neurologic y la Política cultural y de calidad. Define las reglas específicas para **Prueba5**. Sustituye los placeholders y elimina las notas una vez completado.
...
Describe brevemente la finalidad de Prueba5 dentro del ecosistema Neurologic, indicando si genera artefactos reutilizables, una aplicación final o ambos.
...
1. Lista explícita de módulos de Core o scripts compartidos que este proyecto debe reutilizar o producir. Ejemplo:
   ...
   * `Prueba5.Scripts.Validate` – Nueva utilidad solicitada en `csv/artefacts.csv`.
